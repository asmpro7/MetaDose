...
#' @param event.e Numeric vector of numbers of events in the experimental group.
#' @param n.e Numeric vector of sample sizes in the experimental group.
#' @param event.c Numeric vector of numbers of events in the control group.
...
mdbin <- function(measure = c("RR","OR"), event.e, n.e,
                  event.c, n.c, dose, data,
